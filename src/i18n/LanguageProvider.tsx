...
const messages = {
  EN: {
    'nav.mice': 'MICE',
    'nav.home': 'Home', 'nav.packages': 'Packages', 'nav.sri lanka tours': 'Sri Lanka Tours', 'nav.destinations': 'Destinations',
  ...
  FR: {
    'nav.mice': 'MICE',
    'nav.home': 'Accueil', 'nav.packages': 'Circuits', 'nav.sri lanka tours': 'Circuits au Sri Lanka', 'nav.destinations': 'Destinations',
  ...
  DE: {
    'nav.mice': 'MICE',
    'nav.home': 'Startseite', 'nav.packages': 'Reisepakete', 'nav.sri lanka tours': 'Sri Lanka Rundreisen', 'nav.destinations': 'Reiseziele',
  ...
  JA: {
    'nav.mice': 'MICE',
    'nav.home': 'ホーム', 'nav.packages': 'ツアー', 'nav.sri lanka tours': 'スリランカツアー', 'nav.destinations': '目的地',
