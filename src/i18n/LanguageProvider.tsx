...
const messages = {
  EN: {
    ...
    'nav.experiences': 'Experiences', 'nav.accommodations': 'Accommodations', 'nav.shop': 'Shop',
  ...
  FR: {
    ...
    'nav.experiences': 'Expériences', 'nav.accommodations': 'Hébergements', 'nav.shop': 'Boutique',
  ...
  DE: {
    ...
    'nav.experiences': 'Erlebnisse', 'nav.accommodations': 'Unterkünfte', 'nav.shop': 'Shop',
  ...
  JA: {
    ...
    'nav.experiences': '体験', 'nav.accommodations': '宿泊施設', 'nav.shop': 'ショップ',
