...
const messages = {
  EN: {
    ...
    'nav.experiences': 'Experiences', 'nav.corporate experiences': 'Corporate Experiences', 'nav.accommodations': 'Accommodations', 'nav.shop': 'Shop',
  ...
  FR: {
    ...
    'nav.experiences': 'Expériences', 'nav.corporate experiences': 'Expériences d’entreprise', 'nav.accommodations': 'Hébergements', 'nav.shop': 'Boutique',
  ...
  DE: {
    ...
    'nav.experiences': 'Erlebnisse', 'nav.corporate experiences': 'Firmenerlebnisse', 'nav.accommodations': 'Unterkünfte', 'nav.shop': 'Shop',
  ...
  JA: {
    ...
    'nav.experiences': '体験', 'nav.corporate experiences': '企業体験', 'nav.accommodations': '宿泊施設', 'nav.shop': 'ショップ',
